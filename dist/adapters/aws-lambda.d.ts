...
export declare const createOpenApiAwsLambdaHandler: <TRouter extends OpenApiRouter<{
    [x: string]: unknown;
}>, TEvent extends APIGatewayEvent>(opts: CreateOpenApiAwsLambdaHandlerOptions<TRouter, TEvent>) => (event: TEvent, context: APIGWContext) => Promise<{
    statusCode: number;
    headers: {

...
export declare const createOpenApiHttpHandler: <TRouter extends OpenApiRouter<{
    [x: string]: unknown;
}>>(opts: CreateOpenApiHttpHandlerOptions<TRouter>) => (req: IncomingMessage, res: ServerResponse) => Promise<void>;

...
export declare const createOpenApiExpressMiddleware: <TRouter extends OpenApiRouter<{
    [x: string]: unknown;
}>>(opts: CreateOpenApiExpressMiddlewareOptions<TRouter>) => (req: Request, res: Response) => Promise<void>;
